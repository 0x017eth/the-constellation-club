        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              <br />
              <strong>The Constellation Card</strong> is the first NFT issued by <strong>The Foresee Club</strong>, and it's an important certificate for the first members of the club!<br />
              <br />
              Membership to the collective and all of the <strong>benefits</strong> come from holding the Constellation Cards NFT.<br />
              <br />
